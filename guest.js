...
(function(){
  ...
  function buildHero(){
    ...
    el.innerHTML=
      ...
      +'<div class="gh-shelf"><div class="gh-shelf-title">Hammered this year<span class="gh-shelf-note">'+(yr-1)+'–'+yr+' releases Ben has played relentlessly</span>'
      +'</div><div class="gh-bin">'+onRepeatShelf()+'</div></div>'
      +'<div class="gh-shelf"><div class="gh-shelf-title">Hammered last year<span class="gh-shelf-note">'+(yr-2)+'–'+(yr-1)+' releases Ben played relentlessly</span></div><div class="gh-bin">'+prevYearShelf()+'</div></div>'
